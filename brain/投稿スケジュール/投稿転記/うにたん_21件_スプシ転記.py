#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""うにたんの投稿21個（ゆるくダラダラ簡単に稼ぐ）をスプレッドシートに転記。1日3回（6:00, 12:00, 19:00）。"""
...
posts_file = root_dir / "投稿スケジュール/投稿例/うにたん_投稿21個_ゆるく稼ぐ.md"
...
account_file = str(root_dir / "５０アカウント運用/2.うにたん.md")
