#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""はなママの投稿21個（副業背中押し＋失敗しないノウハウ）をスプレッドシートに転記。1日3回（6:00, 12:00, 19:00）。"""
...
posts_file = root_dir / "投稿スケジュール/投稿例/はなママ_投稿21個_副業背中押し.md"
...
account_file = str(root_dir / "５０アカウント運用/5.はなママ.md")
