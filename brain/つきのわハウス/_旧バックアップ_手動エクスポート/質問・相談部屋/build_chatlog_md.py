#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""CSVチャットログと画像を時系列で1つのMarkdownにまとめる（質問・相談部屋用）"""
...
CSV_PATH = os.path.join(SCRIPT_DIR, "chatlogs-1333421829137633422-1355511456040484946.csv")
OUT_PATH = os.path.join(SCRIPT_DIR, "つきのわハウス 質問・相談部屋 チャット履歴.md")
