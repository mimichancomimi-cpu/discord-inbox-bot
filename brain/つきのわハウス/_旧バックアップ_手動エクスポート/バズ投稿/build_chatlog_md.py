#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""CSVチャットログと画像を時系列で1つのMarkdownにまとめる（バズ投稿用）"""
...
CSV_PATH = os.path.join(SCRIPT_DIR, "chatlogs-1333421829137633422-1356260561683349564.csv")
OUT_PATH = os.path.join(SCRIPT_DIR, "つきのわハウス バズ投稿 チャット履歴.md")
